...
{
    public class FollowersParser : SectionParser
    {
        public FollowersParser(CommandLineLogger logger, ExtractFileInfo fileInfo, bool isPreservation, string preservationPrefix, ParserVersionEnum version)
